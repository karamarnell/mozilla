...
-brand-name = Firefox. make an edit
...
fxa-scan-another-email = Want to add another email?
...
fxa-pwt-summary-2 =Short, single-word passwords are easy for hackers to guess. Use at least two words and a combination of letters, digits, and special characters.

fxa-pwt-summary-4 =Password managers like 1Password, LastPass, Dashlane, and Bitwarden store your passwords and fill them in to websites for you. They’ll even help you make strong passwords.

fxa-pwt-summary-6 =Data breaches are on the rise. If your personal info appears in a new data breach, {-product-name} sends you an alert — so you can take action and protect your accounts.

fxa-what-to-do-blurb-1 =If you can’t log in, contact the website to ask how to update it. See an account you don’t recognize? Your data could have been sold or redistributed. This could also be an account you forgot you created or a company that changed names.

fxa-what-to-do-subhead-2 = Stop using the exposed password, and change it everywhere you’ve used it.
fxa-wtd-blurb-2 =Hackers may try to use that same password and your email to get in to other accounts. Create a different and unique password for every account, especially for your bank account, email, and other websites where you save personal information.
...
fxa-what-to-do-blurb-4 =Password managers like 1Password, LastPass, Dashlane, and Bitwarden store your passwords securely and fill them into websites for you. Use a password manager on your phone and computer so you don’t have to remember them all.
...
how-fxm-1-blurb = Search for your email address in public data breaches going back to 2,007
...
wtd-after-website = What to do after a data breach
wtd-after-data-agg = What to do after a data breach
...
appears-in-x-breaches ={ $breachCount -> [one] Appears in { $breachCount } known breach. *[other] Appears in { $breachCount } known breaches. }
...
search-for-your-email = Search for your email address in public data breaches going back to 2,007
...
ba-next-step-blurb-1 =A strong password uses a combination of upper and lowercase letters, special characters, and numbers. It doesn’t contain personal info like your address, birthday, or family names.

ba-next-step-2 = Stop using that exposed password entirely.
ba-next-step-blurb-2 =Cyber criminals could find your password on the dark web and use it to log in to your other accounts. The best way to protect your accounts is to use unique passwords for each one.

ba-next-step-3 = Get help creating better passwords and keeping them safe.
ba-next-step-blurb-3 =Use a password manager to create strong, unique passwords. Password managers securely store all your logins so you can access them across all your devices.
...
new-breaches-found ={ $breachCount -> *[one] { $breachCount } NEW BREACH FOUND [other] { $breachCount } NEW BREACHES FOUND }
...
other-breaches-found ={ $breachCount -> [one] However, it did appear in { $breachCount } other breach. *[other] However, it did appear in { $breachCount } other breaches. }
...
# your localization, because it would result in the number showing twice.
data-breaches-exposed ={ $breaches -> [one] Data breach has exposed your information *[other] Data breaches have exposed your information }
...
# of data breaches that have exposed the user’s information. Don’t add $breaches to
# your localization, because it would result in the number showing twice.
known-data-breaches-exposed ={ $breaches -> [one] Known data breach has exposed your information *[other] Known data breaches have exposed your information }

# Button
see-additional-breaches = See Additional Breaches

scan-results-known-breaches ={ $breachCount -> [one] This email appeared in 1 known data breach. *[other] This email appeared in { $breachCount } known data breaches. }
...
other-known-breaches-found ={ $breachCount -> [one] However, it did appear in { $breachCount } other known breach. *[other] However, it did appear in { $breachCount } other known breaches. }
